...
export default function Contact() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-tight hero-title">
              Contact{" "}
              <span className="bg-gradient-to-r from-red-400 to-pink-500 bg-clip-text text-transparent">Us</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={index}
                className="group bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-red-500/30 transition-all duration-300 service-card text-center hover:bg-gray-800/50"
              >
                <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-pink-600 rounded-xl flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
                ...
                <button className="text-red-400 font-medium hover:text-red-300 transition-colors flex items-center mx-auto text-sm">
                  {contact.action}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Contact Form */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 contact-form">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-300 text-white placeholder-gray-400"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-300 text-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-300 text-white placeholder-gray-400 resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-red-500 to-pink-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-red-600 hover:to-pink-700 transition-all duration-300 flex items-center justify-center animated-button"
                >
                  Send Message
            ...
            <div className="space-y-8 contact-info">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 rounded-xl bg-gray-900/30 border border-gray-700/30 hover:bg-gray-800/30 transition-all duration-300">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-pink-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-400 mt-2">Near Kilpauk Medical College</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 rounded-xl bg-gray-900/30 border border-gray-700/30 hover:bg-gray-800/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-400 mt-2">Available during business hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 rounded-xl bg-gray-900/30 border border-gray-700/30 hover:bg-gray-800/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-400 mt-2">We respond within 24 hours</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-900/30 rounded-xl p-6 border border-gray-700/30">
                ...
                <div className="space-y-2 text-gray-300">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-red-400 font-medium">6:00 AM - 10:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>Saturday</span>
                    <span className="text-red-400 font-medium">6:00 AM - 8:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>Sunday</span>
                    <span className="text-red-400 font-medium">7:00 AM - 6:00 PM</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-900/30 rounded-xl p-6 border border-gray-700/30">
                ...
                <div className="bg-gray-800/50 rounded-lg h-48 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <button className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-red-600 hover:to-pink-700 transition-all duration-300">
                      Open in Google Maps
                    </button>
                  </div>
                </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <button className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-red-600 hover:to-pink-700 transition-all duration-300">
              Contact Our Team
            </button>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-red-500/10 to-pink-500/10 cta-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="cta-content">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-red-600 hover:to-pink-700 transition-all duration-300 animated-button flex items-center justify-center">
