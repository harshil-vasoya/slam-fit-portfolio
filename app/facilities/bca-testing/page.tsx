...
export default function BCATesting() {
  const scope = useGSAP()
            ...
            <div className="space-y-8 lg:space-y-12 text-center lg:text-left max-w-2xl lg:max-w-none mx-auto lg:mx-0">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm text-gray-300 font-medium">Advanced Testing</span>
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight">
                  <span className="hero-title block">Advanced</span>
                ...
                <p className="text-lg sm:text-xl text-gray-300 hero-subtitle leading-relaxed">
                  Advanced body composition analysis for accurate fitness tracking and progress monitoring. 
                  <span className="text-transparent bg-gradient-to-r from-white to-gray-300 bg-clip-text font-semibold">
                    Precision measurements
                  </span> to optimize your fitness journey.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 hero-buttons justify-center lg:justify-start">
                <button className="group relative bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:shadow-[0_0_50px_rgba(255,255,255,0.3)] transition-all duration-500 flex items-center justify-center animated-button hover:scale-110 hover:-translate-y-2 overflow-hidden">
                  ...
                  <span className="relative z-10">Book Test</span>
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-8 lg:space-x-12 text-white hero-stats">
                <div className="flex items-center space-x-3 group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-300 text-sm leading-tight">(100+ reviews)</span>
                  </div>
                </div>
                <div className="flex items-center space-x-3 group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold stat-number text-lg leading-none">200+</span>
                    <span className="text-gray-300 text-sm leading-tight">Tests Done</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-10">
              <div>
                <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm text-gray-300 font-medium">BCA Testing Features</span>
                </div>
                <h2 className="text-5xl font-black text-white reveal-text mb-6">
                  Why Choose Our{" "}
                  <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">BCA Testing</span>
                  ?
                </h2>
                <p className="text-xl text-gray-300 reveal-text leading-relaxed">
                  Advanced body composition analysis with precise measurements to track your fitness progress and optimize your training.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="cta-content">
            <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-sm text-gray-300 font-medium">Track Progress!</span>
            </div>
            <h2 className="text-5xl sm:text-6xl font-black text-white mb-8">
              Get{" "}
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Precise Results</span>
            </h2>
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Book your BCA test today and get accurate body composition analysis to track your fitness progress.
            </p>
