      ...
      >
        <div className="absolute inset-0">
          ...
          <div className="absolute top-25 right-4 md:right-40 w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-gray-600/30 to-gray-700/30 rounded-3xl floating backdrop-blur-xl border border-white/10 shadow-2xl">
            <Droplets className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 md:w-16 md:h-16 text-gray-400" />
          </div>
          <div className="absolute top-1/2 right-2 md:right-20 w-18 h-18 md:w-24 md:h-24 bg-gradient-to-br from-gray-500/30 to-gray-600/30 rounded-3xl floating backdrop-blur-xl border border-white/10 shadow-2xl">
            <Thermometer className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 md:w-12 md:h-12 text-gray-400" />
          </div>
            ...
            <div className="space-y-8 lg:space-y-12 text-center lg:text-left max-w-2xl lg:max-w-none mx-auto lg:mx-0">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm text-gray-300 font-medium">Premium Facility</span>
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight">
                  <span className="hero-title block">Premium</span>
                ...
                <p className="text-lg sm:text-xl text-gray-300 hero-subtitle leading-relaxed">
                  Experience ultimate relaxation and recovery in our state-of-the-art steam room. 
                  <span className="text-transparent bg-gradient-to-r from-white to-gray-300 bg-clip-text font-semibold">
                    Rejuvenate your body and mind
                  </span> with therapeutic steam sessions designed for post-workout recovery.
                </p>
              </div>
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-8 lg:space-x-12 text-white hero-stats">
                ...
                <div className="flex items-center space-x-3 group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold stat-number text-lg leading-none">1000+</span>
                    <span className="text-gray-300 text-sm leading-tight">sessions</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-10">
              <div>
                <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm text-gray-300 font-medium">Steam Room Benefits</span>
                </div>
                ...
                <p className="text-xl text-gray-300 reveal-text leading-relaxed">
                  Experience the therapeutic benefits of steam therapy in our premium facility designed for maximum comfort and relaxation.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 features-image">
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-gray-500/20 to-gray-600/20 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                    <div className="text-3xl font-bold text-white mb-2">45°C</div>
                    <div className="text-gray-300">Optimal Temperature</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="cta-content">
            <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-sm text-gray-300 font-medium">Ready to Relax?</span>
            </div>
            <h2 className="text-5xl sm:text-6xl font-black text-white mb-8">
              Experience Ultimate{" "}
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Relaxation</span>
            </h2>
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Book your steam room session today and experience the therapeutic benefits of premium steam therapy. 
