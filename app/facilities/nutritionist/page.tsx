            ...
            <div className="space-y-8 lg:space-y-12 text-center lg:text-left max-w-2xl lg:max-w-none mx-auto lg:mx-0">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm text-gray-300 font-medium">Personalized Service</span>
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight">
                  <span className="hero-title block">Expert</span>
                ...
                <p className="text-lg sm:text-xl text-gray-300 hero-subtitle leading-relaxed">
                  Personalized nutrition guidance to complement your fitness journey. 
                  <span className="text-transparent bg-gradient-to-r from-white to-gray-300 bg-clip-text font-semibold">
                    Expert advice
                  </span> to fuel your performance and achieve your goals.
                </p>
              </div>
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-8 lg:space-x-12 text-white hero-stats">
                <div className="flex items-center space-x-3 group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-300 text-sm leading-tight">(120+ reviews)</span>
                  </div>
                </div>
                <div className="flex items-center space-x-3 group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold stat-number text-lg leading-none">300+</span>
                    <span className="text-gray-300 text-sm leading-tight">Clients</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-10">
              <div>
                <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
                  ...
                  <span className="text-sm text-gray-300 font-medium">Nutrition Services</span>
                </div>
                <h2 className="text-5xl font-black text-white reveal-text mb-6">
                  Why Choose Our{" "}
                  <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Nutritionist</span>
                  ?
                </h2>
                <p className="text-xl text-gray-300 reveal-text leading-relaxed">
                  Expert nutrition guidance tailored to your fitness goals, lifestyle, and dietary preferences for optimal results.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="cta-content">
            <div className="inline-flex items-center gap-2 bg-gray-500/10 backdrop-blur-sm border border-gray-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-sm text-gray-300 font-medium">Fuel Your Goals!</span>
            </div>
            <h2 className="text-5xl sm:text-6xl font-black text-white mb-8">
              Get{" "}
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Expert Guidance</span>
            </h2>
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Book a consultation with our expert nutritionist and get personalized nutrition guidance to fuel your fitness journey.
            </p>
